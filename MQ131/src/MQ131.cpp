...
#include "Particle.h"
#line 1 "c:/Users/IoT_Instructor/Documents/Particle/MQ131/src/MQ131.ino"
/*
 * Project MQ131
 * Description:
 * Author:
...
void setup(void);
void loop(void);
#line 12 "c:/Users/IoT_Instructor/Documents/Particle/MQ131/src/MQ131.ino"
ADC121C_MQ131 mq131;
...
void loop(void)
{
    ...
    if (error == 0)
    {
        ...
        Serial.printf("Rs/Ro = %02f \n",mq131.Measure_RatioRsRo());
        Serial.printf("Ro %0.2f \n ", mq131.Measure_Ro());
        Serial.printf("O3 Conc = %02f \n",pow(10,(-1/0.75)*log(mq131.Measure_RatioRsRo())+2.15));
        Serial.printf("Voltage = %04X \n", mq131.Measure_Voltage());
        Serial.printf("Old style O3 Conc %02f \n", (1.99 / 4096.0) * mq131.Measure_Voltage() + 0.01);
