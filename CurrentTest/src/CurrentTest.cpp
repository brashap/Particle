...
#line 1 "c:/Users/IoTPa/Documents/Particle/CurrentTest/src/CurrentTest.ino"
...
void setup();
void loop();
#line 11 "c:/Users/IoTPa/Documents/Particle/CurrentTest/src/CurrentTest.ino"
#define Addr 0x2A
...
void loop()
{
  for (int j = 1; j < noOfChannel + 1; j++)
  {
    ...
    int msb = Wire.read();
    int lsb = Wire.read();
    Serial.printlnf("The readings are %i, %i, and %i",msb1,msb,lsb);
