...
#include "Particle.h"
#line 1 "c:/Users/IoTPa/Documents/Particle/Ted1/src/Ted1.ino"
/*
 * Project Attic_Fan_Controller (TEST2)
 * Description:
...
#line 23 "c:/Users/IoTPa/Documents/Particle/Ted1/src/Ted1.ino"
const bool ON=1, OFF=0;
const float MIN_TEMP=79.0, MIN_HUM=99.0;
const int ORIENT_LANDSCAPE=0;
...
void ML01_MANUAL_OPS_SCREEN(bool inManMode)
{
  ...
  display.setRotation(ORIENT_LANDSCAPE);
  display.printf("BUTTON MODE\n");
